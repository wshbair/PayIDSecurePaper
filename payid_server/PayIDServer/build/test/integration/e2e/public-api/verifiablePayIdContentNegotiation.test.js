...
const XRPL_EXPECTED_TESTNET_RESPONSE = {
    ...
    verifiedAddresses: [
        {
            signatures: [payloads_1.SIGNATURE],
            payload: JSON.stringify({
                payId: PAYID,
                payIdAddress: payloads_1.XRPL_TESTNET_ADDRESS,
            }),
        },
    ],
    payId: PAYID,
};
describe('E2E - publicAPIRouter - Verifiable PayId Content Negotiation', function () {
    ...
    it('Returns the preferred available address where the higher q is at the end', function (done) {
        ...
        const acceptHeader = `${payloads_1.XRPL_MAINNET_ACCEPT_HEADER}; q=0.5, ${payloads_1.XRPL_TESTNET_ACCEPT_HEADER}; q=1.1`;
        // WHEN we make a GET request to the public endpoint to retrieve payment info with an Accept header specifying
    ...
    it('Returns a valid address when the most preferred type does not exist', function (done) {
        ...
        const acceptHeader = `${nonExistentAcceptType}; q=1.1, ${payloads_1.XRPL_MAINNET_ACCEPT_HEADER}; q=0.5, ${payloads_1.XRPL_TESTNET_ACCEPT_HEADER}; q=0.9`;
        // WHEN we make a GET request to the public endpoint to retrieve payment info with an Accept header specifying
...
//# sourceMappingURL=verifiablePayIdContentNegotiation.test.js.map
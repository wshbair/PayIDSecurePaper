...
let app;
describe('E2E - publicAPIRouter - Base PayID', function () {
    ...
    it('Returns a 404 with the correct error response object for an unknown PayID', function (done) {
    ...
    it('Returns a 404 for a PayID request with payid+json, when that PayID has been deleted', function (done) {
...
//# sourceMappingURL=basePayId.test.js.map
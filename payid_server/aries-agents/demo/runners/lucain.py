...
async def main(
    ...
    try:
        ...
        with log_timer("Publish schema/cred def duration:"):
            ...
            (
                _,  # schema id     # has been:   ["name", "date", "degree", "age", "timestamp"],
        ...
        async for option in prompt_loop(options):
            ...
            if option is None or option in "xX":
                ...
                log_status("#20 Request proof of payid from alice")
                req_attrs = [
                ...
                if revocation:
                    ...
                    req_attrs.append(
                        {"name": "payid", "restrictions": [{"issuer_did": agent.did}]}
                    )
                if SELF_ATTESTED:
                    # test self-attested claims
                    req_attrs.append(
                        {"issuer_name": "self_attested_thing"},
                    )
                req_preds = [

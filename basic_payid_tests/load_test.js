...
export let options = {
    stages: [
        { duration: '60s', target: 1000 }, // simulate ramp-up of traffic from 1 to 1000 users over 60 secconds.
        { duration: '120s', target:2000 }, // stay at 2000 users for 120 seconds 
